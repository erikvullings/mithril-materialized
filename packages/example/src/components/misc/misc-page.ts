import { MaterialBox, CodeBlock, Collabsible, Carousel, Parallax } from 'mithril-materialized';
    ...
    view: () =>
      m('.col.s12.m8.xl7', [
        ...
        m('p', [
          ...
          ' and the ',
          m('a[href=https://materializecss.com/parallax.html#!][target=_blank]', 'Parallax'),
          '.',
        ]),
